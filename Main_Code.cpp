...
int main()
{
int i,player1=0,player2=0,lastposition;
...
{
board();
gamescore(name1,name2,player1,player2);
cout<<"\n\n--->" <<name1<<" Now your Turn >> Press any key to play ";
getch();
lastposition=player1;
play_dice(player1);
if(player1<lastposition)
cout<<"\nSnake found! You are at postion "<<player1<<"\n";

else if(player1>lastposition+6)
cout<<"\n you got a ladder! You are at position "<<player1;
if(player1==100)
{
player1=100;
lastposition=100;
}
cout<<"\n\n--->"<<name2<<" Now your Turn >> Press any key to play ";
getch();
lastposition=player2;
play_dice(player2);
if(player2<lastposition)
cout<<"\n Snake found! You are at position "<<player2<<"\n";

else if(player2>lastposition+6)
cout<<"\n you got a ladder! You are at position "<<player2<<"\n";
getch();
}
if(player2==100)
{
...
cout<<"\n\n\n";
if(player1>=player2)
cout<<name1<<" !! You are the winner of the game\n\n";

else
cout<<name2<<" !! You are the winner of the game\n\n";
draw_line(50,'+');
getch()
;
}
